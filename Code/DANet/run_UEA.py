...
parser.add_argument('--data_path', type=str, default='drive/MyDrive/1-time-series classification in manufacturing/Code/DANet/data/')
parser.add_argument('--seed', type=int, default=1, help='random seed')
parser.add_argument('--dropout', type=float, default=0.05, help='attention dropout rate')
parser.add_argument('--batch_size', type=int, default=16)
parser.add_argument('--n_epochs', type=int, default=50)
parser.add_argument('--cache_path', type=str, default='drive/MyDrive/1-time-series classification in manufacturing/Code/DANet/cache')
