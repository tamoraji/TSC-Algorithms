...
parser.add_argument('--distance', type=str, default='dtw',
                    help= "distance measurement. choose from: 'euclidean', 'squared', 'dtw', 'ddtw', 'wdtw', 'wddtw', 'lcss', 'edr', 'erp', 'msm', 'twe' " )
...
## Implement the classifier on the first dimention
t_total = time.time() ##Start timing
from sktime.classification.distance_based import KNeighborsTimeSeriesClassifier
classifier = KNeighborsTimeSeriesClassifier(distance=args.distance, n_jobs=-1)
