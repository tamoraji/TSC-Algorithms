...
parser.add_argument('--n_trees', type=float, default=500, #regularization strength
...
classifier = RandomForestClassifier(n_estimators=args.n_trees, n_jobs=-1, verbose=1)
